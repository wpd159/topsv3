...
public class CredencialUsuarioEntity {
  ...
  public static CredencialUsuarioEntity criarAcessoPendente(
      UUID id,
      UUID usuarioId,
      String senhaHash,
      OffsetDateTime criadoEm) {
    CredencialUsuarioEntity entity = criar(id, usuarioId, senhaHash, criadoEm);
    entity.precisaRedefinir = true;
    return entity;
  }
