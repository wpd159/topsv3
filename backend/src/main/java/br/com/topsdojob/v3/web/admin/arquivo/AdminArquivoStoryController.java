...
@RestController
@RequestMapping("/api/admin/registros/stories")
@PreAuthorize("hasRole('ADMIN') and hasAuthority('ARQUIVO_PUBLICIDADE_LER')")
public class AdminArquivoStoryController {
  private final AdminArquivoStoryService service;
  private final ObjectMapper mapper;

  public AdminArquivoStoryController(AdminArquivoStoryService service, ObjectMapper mapper) {
  ...
  public ResponseEntity<byte[]> exportar(
    ...
    return ResponseEntity.ok().cacheControl(CacheControl.noStore())
        ...
        .header(HttpHeaders.CONTENT_DISPOSITION,
            "attachment; filename=publicidade-story-" + id + ".json")
  ...
  public ResponseEntity<byte[]> arquivo(
    ...
    return ResponseEntity.ok().cacheControl(CacheControl.noStore())
        ...
        .header("X-Content-Type-Options", "nosniff")
        .header(HttpHeaders.CONTENT_DISPOSITION,
            "attachment; filename=publicidade-story-midia-" + midiaId)
