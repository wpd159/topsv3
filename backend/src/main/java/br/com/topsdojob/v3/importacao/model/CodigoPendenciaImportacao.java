...
public enum CodigoPendenciaImportacao {
    ...
    PAGAMENTO_HISTORICO_PROVEDOR_AUSENTE(SeveridadePendenciaImportacao.BLOQUEANTE),
    PAGAMENTO_HISTORICO_ESTADO_INCOMPLETO(SeveridadePendenciaImportacao.BLOQUEANTE),
    PAGAMENTO_HISTORICO_VALOR_INCONSISTENTE(SeveridadePendenciaImportacao.BLOQUEANTE),
    PAGAMENTO_HISTORICO_CREDITOS_INCONSISTENTES(SeveridadePendenciaImportacao.BLOQUEANTE),
    PAGAMENTO_HISTORICO_DATA_AUSENTE(SeveridadePendenciaImportacao.BLOQUEANTE),
    PAGAMENTO_HISTORICO_USUARIO_NAO_MAPEADO(SeveridadePendenciaImportacao.BLOQUEANTE),
    PAGAMENTO_HISTORICO_PLANO_NAO_MAPEADO(SeveridadePendenciaImportacao.BLOQUEANTE),
    ATIVACAO_FINANCEIRA_USUARIO_NAO_MAPEADO(SeveridadePendenciaImportacao.BLOQUEANTE),
    ATIVACAO_FINANCEIRA_ANUNCIO_NAO_MAPEADO(SeveridadePendenciaImportacao.BLOQUEANTE),
    ATIVACAO_FINANCEIRA_OWNERSHIP_DIVERGENTE(SeveridadePendenciaImportacao.BLOQUEANTE),
    ATIVACAO_FINANCEIRA_PRODUTO_NAO_MAPEADO(SeveridadePendenciaImportacao.BLOQUEANTE),
    ATIVACAO_FINANCEIRA_GRUPO_INCONSISTENTE(SeveridadePendenciaImportacao.BLOQUEANTE),
    ATIVACAO_FINANCEIRA_VIGENCIA_INVALIDA(SeveridadePendenciaImportacao.BLOQUEANTE),
    ATIVACAO_FINANCEIRA_ORIGEM_INCONSISTENTE(SeveridadePendenciaImportacao.BLOQUEANTE),
    SALDO_FINANCEIRO_USUARIO_NAO_MAPEADO(SeveridadePendenciaImportacao.BLOQUEANTE),
    SALDO_FINANCEIRO_NEGATIVO(SeveridadePendenciaImportacao.BLOQUEANTE),
    SALDO_FINANCEIRO_DUPLICADO(SeveridadePendenciaImportacao.BLOQUEANTE),
    SALDO_FINANCEIRO_LEDGER_EXISTENTE(SeveridadePendenciaImportacao.BLOQUEANTE);
