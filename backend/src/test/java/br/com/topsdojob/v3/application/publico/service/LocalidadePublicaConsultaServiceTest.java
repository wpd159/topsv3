...
class LocalidadePublicaConsultaServiceTest {
    ...
    void contaAnunciosElegiveisPorIdSemDeduplicarProprietario() {
        ...
        when(elegibilidadeService.avaliarLocalidades(any(), any())).thenReturn(Map.of(
                ...
                anuncioInelegivelId, new AnuncioSeoElegibilidadeConsultaService.Resultado(false,
        ...
        assertThat(estadoDto.ultimaAtualizacao()).isEqualTo(OffsetDateTime.parse("2026-09-08T12:00:00Z"));
        assertThat(cidadeDto.ultimaAtualizacao()).isEqualTo(OffsetDateTime.parse("2026-09-08T12:00:00Z"));
        assertThat(bairroDto.ultimaAtualizacao()).isEqualTo(OffsetDateTime.parse("2026-09-08T12:00:00Z"));
    }
