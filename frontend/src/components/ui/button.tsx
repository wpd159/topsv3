...
const buttonVariants = cva(
  "inline-flex items-center rounded-3xl justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:enabled:shadow-[0_0_10px_rgba(252,30,173,0.45)] active:enabled:shadow-[0_0_4px_rgba(252,30,173,0.6)]",
  {
    variants: {
      variant: {
