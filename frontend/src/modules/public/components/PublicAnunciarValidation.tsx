...
const MESSAGE_BY_CODE: Record<string, string> = {
  ...
  TITULO_CONTATO_OU_REDE_SOCIAL: "nao coloque contato ou rede social no titulo",
  TITULO_SPAM: "ajuste o titulo do anuncio",
  CAMPO_PERIGOSO: "remova informacoes que nao pertencem a esta etapa",
  CAMPO_NAO_PERMITIDO: "remova informacoes que nao pertencem a esta etapa",
