...
assert.match(storyViewer, /backgroundImage=\{currentFeedItem\.previewUrl\}/)
assert.match(storyViewer, /backgroundImage=\{viewerItem\.midiaUrl \?\? currentFeedItem\.previewUrl\}/)
