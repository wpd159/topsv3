...
assert.match(files.manager, /Planos e creditos/)
assert.match(files.manager, /Novo plano/)
...
assert.match(files.manager, /Nenhum plano encontrado/)
...
assert.match(files.manager, /if \(salvando\) return/)
