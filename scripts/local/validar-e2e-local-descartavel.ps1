...
function Apply-Migrations {
  ...
  if ($files.Count -ne 23) { throw "Quantidade esperada de migrations V001-V023 nao encontrada: $($files.Count)" }
  ...
  Add-Step "Migrations V001-V023 aplicadas via psql ordenado no PostgreSQL descartavel."
}
