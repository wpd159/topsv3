...
function Apply-Migrations {
  ...
  if ($files.Count -ne 25) { throw "Quantidade esperada de migrations V001-V025 nao encontrada: $($files.Count)" }
  ...
  Add-Step "Migrations V001-V025 aplicadas via psql ordenado no PostgreSQL descartavel."
}
