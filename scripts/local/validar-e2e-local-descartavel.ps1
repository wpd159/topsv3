...
function Apply-Migrations {
  ...
  if ($files.Count -ne 24) { throw "Quantidade esperada de migrations V001-V024 nao encontrada: $($files.Count)" }
  ...
  Add-Step "Migrations V001-V024 aplicadas via psql ordenado no PostgreSQL descartavel."
}
