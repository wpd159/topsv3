...
-- O catalogo Premium canonico e semeado pela V024. Stories permanecem no fluxo proprio.
...
INSERT INTO ativacao_beneficio (
  ...
  (
    ...
    0,
    NULL,
    'premium-sintetico-carrossel-ativo',
    NULL,
    NULL,
    now()
  ),
  ...
  (
    ...
    0,
    NULL,
    'premium-sintetico-whatsapp-card-ativo',
    NULL,
    NULL,
    now()
  )
