...
- Categorias e idade publica: `backend/src/main/resources/db/migration/V021__categorias_home_idade_publica.sql`, `backend/src/main/resources/db/migration/V027__vinculo_canonico_categorias_home.sql`, `backend/src/main/resources/db/migration/V028__rbac_configuracao_admin.sql`, `backend/src/main/java/br/com/topsdojob/v3/domain/anuncio/CategoriaAnuncio.java`, `backend/src/main/java/br/com/topsdojob/v3/web/admin/conteudo/AdminCategoriaHomeController.java`, `backend/src/main/java/br/com/topsdojob/v3/web/publico/CategoriaHomePublicaController.java`, `backend/src/main/java/br/com/topsdojob/v3/application/publico/service/ListagemPublicaConsultaService.java`, `backend/src/main/java/br/com/topsdojob/v3/application/publico/service/IdadeAnunciantePublicaService.java`, `backend/src/test/java/br/com/topsdojob/v3/migration/RbacConfiguracaoAdminMigrationTest.java`, `backend/src/test/java/br/com/topsdojob/v3/web/admin/conteudo/AdminCategoriaHomeRbacMethodSecurityTest.java`, `frontend/src/lib/admin-categorias-home-api.ts`, `frontend/src/lib/public-catalog-api.ts`
