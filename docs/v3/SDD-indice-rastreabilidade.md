...
- Contrato autenticado de anuncios: `backend/src/main/java/br/com/topsdojob/v3/web/publico/anunciante/MeusAnunciosController.java`, `backend/src/main/java/br/com/topsdojob/v3/application/publico/anunciante/MeusAnunciosConsultaService.java`
- Adapter e rotas de Meus anuncios: `frontend/src/lib/meus-anuncios-api.ts`, `frontend/src/app/(private-routes)/meus-anuncios/page.tsx`, `frontend/src/app/(private-routes)/meus-anuncios/[slug]/page.tsx`, `frontend/src/app/(private-routes)/meus-anuncios/[slug]/editar/page.tsx`
- Testes de propriedade e contrato frontend: `backend/src/test/java/br/com/topsdojob/v3/application/publico/anunciante/MeusAnunciosConsultaServiceTest.java`, `backend/src/test/java/br/com/topsdojob/v3/web/publico/anunciante/MeusAnunciosFrontendContractTest.java`
...
- Categorias e idade publica: `backend/src/main/resources/db/migration/V021__categorias_home_idade_publica.sql`, `backend/src/main/java/br/com/topsdojob/v3/web/publico/CategoriaHomePublicaController.java`, `backend/src/main/java/br/com/topsdojob/v3/application/publico/service/IdadeAnunciantePublicaService.java`, `frontend/src/lib/public-catalog-api.ts`
