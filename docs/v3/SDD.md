...
- O painel usa exclusivamente `/api/admin/categorias-home` para criar e editar vinculo, nome, descricao, ordem, status e imagem. A taxonomia vem do backend, a imagem continua no R2 canonico, a ordem e unica e dois cards ativos nao podem compartilhar categoria.
