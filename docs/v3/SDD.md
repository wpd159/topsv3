...
- O frontend vindo do clone ainda referencia contratos legados de descoberta/listagem que nao existem no backend V3. As seis pendencias nao bloqueiam o fechamento desta fase estrutural, mas estado, indices de localidades e sitemap dinamico permanecem bloqueados para homologacao SEO ate haver adapter V3 ou contrato publico equivalente; nao criar conteudo ou URLs artificiais para mascarar essa lacuna.
