...
- Prefixo Docker: topsv3-agegate-whatsapp-sintetico
- Somente smoke HTTP: True
- API smoke script: C:\topsv3\scripts\local\validar-agegate-whatsapp-sintetico-local.ps1
- Fixture sintetica JSON: C:\topsv3\backend\src\test\resources\fixtures\v3-dados-sinteticos.json
- Porta PostgreSQL efemera: 59458
...
- Backend local iniciado em perfil local na porta 18139.
