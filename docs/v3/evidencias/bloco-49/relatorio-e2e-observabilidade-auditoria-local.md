...
- Prefixo Docker: topsv3-observabilidade-local
- Somente smoke HTTP: True
- API smoke script: C:\topsv3\scripts\local\validar-observabilidade-auditoria-local.ps1
- Fixture sintetica JSON: C:\topsv3\backend\src\test\resources\fixtures\v3-dados-sinteticos.json
- Porta PostgreSQL efemera: 52375
...
- Backend local iniciado em perfil local na porta 18149.
