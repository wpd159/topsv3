...
- Restore externo: `C:\topsv3-auditoria-local\restore\bloco-29-4`
...
- Restore usa single transaction: sim
...
- Network exclusiva ja existente e reaproveitada: topsv3-bloco29-net.
- Volume exclusivo ja existente e reaproveitado: topsv3-bloco29-pgdata-bruto.
- Volume exclusivo ja existente e reaproveitado: topsv3-bloco29-pgdata-sanitizado.
- Container proprio existente verificado/reaproveitado: topsv3-bloco29-pg17-bruto.
- Container proprio existente verificado/reaproveitado: topsv3-bloco29-pg17-sanitizado.
