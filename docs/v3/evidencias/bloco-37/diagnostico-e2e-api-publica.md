...
- Prefixo Docker: topsv3-bloco37-diagnostico
- API smoke script: C:\topsv3\scripts\local\validar-api-publica-local.ps1
- Fixture sintetica JSON: C:\topsv3\backend\src\test\resources\fixtures\v3-dados-sinteticos.json
- Porta PostgreSQL efemera: 61350
...
- Backend local iniciado em perfil local na porta 18137.
