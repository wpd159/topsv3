...
- OK: desktop/inicio: sem upload/camera/documento real - ok
...
- OK: desktop/validacao: sem upload/camera/documento real - ok
...
- OK: desktop/midia: sem upload/camera/documento real - ok
...
- OK: desktop/revisao: sem upload/camera/documento real - ok
...
- OK: desktop/pos-envio: sem upload/camera/documento real - ok
...
- OK: mobile/inicio: sem upload/camera/documento real - ok
...
- OK: mobile/validacao: sem upload/camera/documento real - ok
...
- OK: mobile/midia: sem upload/camera/documento real - ok
...
- OK: mobile/revisao: sem upload/camera/documento real - ok
...
- OK: mobile/pos-envio: sem upload/camera/documento real - ok
...
- OK: API local sem efeito real: publicado - ok
- OK: API local sem efeito real: publicacaoAutomaticaExecutada - ok
- OK: API local sem efeito real: uploadRealExecutado - ok
- OK: API local sem efeito real: pagamentoCriado - ok
- OK: API local sem efeito real: creditoCriado - ok
- OK: API local sem efeito real: premiumObrigatorio - ok
- OK: API local sem efeito real: emailRealEnviado - ok
- OK: API local sem efeito real: whatsappRealEnviado - ok
