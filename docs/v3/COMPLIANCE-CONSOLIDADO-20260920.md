...
| F06 | Ausência de trilha equivalente confirmada no caminho de leitura. Auditoria específica reutiliza o repositório existente e transação independente; permitidos, negativas RBAC HTTP, inexistência e falha de storage têm provas sintéticas. Registros necessários persistem apesar de rollback externo. |
